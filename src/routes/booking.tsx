...
import useCacheCleaner from "../hooks/queries/use-cache-cleaner"
  ...
  return (
    <Container>
      <Suspense fallback={spinner}>
        {(tablesQuery.isLoading || bookingsQuery.isLoading) && spinner}

        {tablesQuery.isError && (
          <Alert variant="danger" className="w-50 mx-auto">
            Не удалось загрузить данные о доступных столиках. Попробуйте
        ...
        {bookingsQuery.isError && (
          <Alert variant="danger" className="w-50 mx-auto">
            Не удалось загрузить данные о бронированиях. Попробуйте
            перезагрузить страницу.
          </Alert>
        )}

        {tablesQuery.isSuccess && bookingsQuery.isSuccess && (
          <>
            {canBook ? (
                  ...
                  <fieldset disabled={!canBook}>
                    ...
                    >
                      ...
                      <DatePicker
                        ...
                        onCalendarOpen={() =>
                          !values.time &&
                          scrollToFirstAvailableTime(timeContainerRef)
                        }
                    ...
                    <Form.Group
                      controlId="validationFormikGuests"
                      className="mt-3"
                    >
